...
<dd class="symbol-details member protected  collapsible-symbol">
	<div class="symbol-details-inner">
			...
			<h4 id="testMethod" class="function public inherited"><span class="name">testMethod</span><span class="signature-params">( <span class="signature-param">value</span>, <span class="signature-param">obj</span> [,&nbsp;<span class="signature-param">...objN</span>&nbsp;]&nbsp;)</span><span class="signature-type"> &rarr;&nbsp;{Object}</span></h4>
