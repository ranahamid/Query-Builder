...
<body>
	...
	<!-- end:navbar.hbs -->		<div class="page-header">
			<div class="container">
				...
				<h1><span class="ancestors"><a href="MyApi.html">MyApi</a>.</span><span class="name">Class</span></h1>
				<div class="summary"><p>This is the summary of the MyApi test class, test <code>markdown</code>.</p></div>			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9 main-content">
						<ol class="breadcrumb">
							...
							<li class="active"><a href="MyApi.html">MyApi</a>.Class</li>
						</ol>
			...
			<h2 class="class"><span class="signature-new">new&nbsp;</span><span class="name">Class</span><span class="signature-params">( <span class="signature-param">arg1</span> [,&nbsp;<span class="signature-param">...arg2</span>&nbsp;]&nbsp;)</span><span class="signature-type"></span></h2>
		<div class="summary"><p>This is the summary of the MyApi test class, test <code>markdown</code>.</p></div></dt>
<dd class="symbol-details class  collapsible-symbol expanded" style="max-height: 9999px;">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description"><p>This is the description for the class this is meant to be a more in depth explanation of what this class does and it's general use case, test <code>markdown</code></p></div>
					...
					<tbody>
						<tr>
							...
							<td><span class="param-type">string</span></td>
								...
								<td></td>
							<td class="last">
									<p>The first test arg, test <code>markdown</code>.</p>
							</td>
						</tr>
						<tr>
							...
							<td><span class="param-type">string</span></td>
								...
								<td>false</td>
							<td class="last">
									<p>A repeatable, optional argument with a default value of false, test <code>markdown</code>.</p>
							</td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="callout callout-example"><h5>Examples</h5>		<div class="example-caption"><p>You can provide example captions with <code>markdown</code> and specify the language to use when rendering the code, defaults to <code>javascript</code>.</p></div>
					<div class="example-code">
						<pre class="prettyprint source language-javascript"><code class="language-javascript">var gc &#x3D; new GlobalClass(&quot;arg1&quot;, &quot;arg2&quot;);</code></pre>
					</div>
					<div class="example-code">
						<pre class="prettyprint source language-xml"><code class="language-xml">&lt;head&gt;	&lt;title&gt;HTML Highlighting&lt;/title&gt;	&lt;script&gt;	  // supports embedded languages		var gc &#x3D; new GlobalClass(&quot;arg1&quot;, &quot;arg2&quot;);	&lt;/script&gt;&lt;/head&gt;</code></pre>
					</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-25">line 25</a></p>
								</div>
							</div>
			...
			<h4 id="publicMember" class="member public"><span class="name">publicMember</span><span class="signature-type"> :string</span></h4>
	...
	<div class="symbol-details-inner">
			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-52">line 52</a></p>
								</div>
							</div>
											...
											<hr/>
											<dt class="symbol-title member private collapsible-symbol">
			<h4 id="_privateMember" class="member private"><span class="signature-attribs">&lt;private> </span><span class="name">_privateMember</span><span class="signature-type"> :string</span></h4>
				<div class="summary"><p>I'm a private member of the class.</p></div></dt>
<dd class="symbol-details member private  collapsible-symbol">
	<div class="symbol-details-inner">
			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
			...
			<h4 id="testMethod" class="function public"><span class="name">testMethod</span><span class="signature-params">( <span class="signature-param">value</span>, <span class="signature-param">obj</span> [,&nbsp;<span class="signature-param">...objN</span>&nbsp;]&nbsp;)</span><span class="signature-type"> &rarr;&nbsp;{Object}</span></h4>
...
<dd class="symbol-details function public  collapsible-symbol">
	<div class="symbol-details-inner">
			...
			<div class="callout callout-success"><h5>Returns</h5>		<form class="form-horizontal returns">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label fires-event"><a href="MyApi.Class.html#~event:test.my-api">"test.my-api"</a></label>
								<div class="col-sm-9">
									<div class="form-control-static fires-summary">This is an event raised by this class, it's documentation appears on this page as the event is specified as an inner member the class by using the tilde (~) scope.</div>
								</div>
							</div>
					</form>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-72">line 72</a></p>
											...
											<hr/>
											<dt class="symbol-title function public collapsible-symbol">
			<h4 id="anotherMethod" class="function public"><span class="name">anotherMethod</span><span class="signature-params">( <span class="signature-param">value</span>, <span class="signature-param">obj</span> [,&nbsp;<span class="signature-param">...objN</span>&nbsp;]&nbsp;)</span><span class="signature-type"> &rarr;&nbsp;{Object}</span></h4>
				<div class="summary"><p>This is a another test instance method of the MyApi test class, test <code>markdown</code>.</p></div></dt>
<dd class="symbol-details function public  collapsible-symbol">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description"><p>This method is overridden in the <a href="MyApi.Child.html">MyApi.Child</a> class and should remove the exception documentation as it no longer applies.</p></div>
			</div>			<div class="callout callout-info">
				<h5>Parameters</h5>
				<table class="params table table-striped">
					<thead>
			...
			<div class="callout callout-success"><h5>Returns</h5>		<form class="form-horizontal returns">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label fires-event"><a href="MyApi.Class.html#~event:another.my-api">"another.my-api"</a></label>
								<div class="col-sm-9">
									<div class="form-control-static fires-summary">This is an event raised by this class, it's documentation appears on this page as the event is specified as an inner member the class by using the tilde (~) scope.</div>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-95">line 95</a></p>
								</div>
							</div>
			...
			<h4 id="~Object" class="typedef public"><span class="name">Object</span></h4>
				<div class="summary"><p>This is a test type definition on the MyApi.Class class.</p></div></dt>
	...
	<div class="symbol-details-inner">
					...
					<tbody>
						<tr>
							...
							<td><span class="param-type">string</span></td>
								...
								<td></td>
							<td class="last">
									<p>The name of the test object.</p>
							</td>
						</tr>
						<tr>
							...
							<td><span class="param-type">boolean</span></td>
								...
								<td>false</td>
							<td class="last">
									<p>Whether or not the test object is enabled. Defaults to <code>false</code>.</p>
							</td>
						</tr>
						<tr>
								<td><code>sub</code></td>
							<td><span class="param-type">Object</span></td>
								...
								<td></td>
							<td class="last">
									<p>An object containing a subset of properties.</p>
										<table class="params table table-striped">
											<thead>
											<tr>
													<th>Name</th>
											...
											<tbody>
												...
												<tr>
													...
													<td><span class="param-type">boolean</span></td>
														...
														<td>&quot;Sub Options&quot;</td>
													<td class="last">
															<p>The name of the sub object. Defaults to <code>&quot;Sub Options&quot;</code>.</p>
													</td>
												</tr>
											</tbody>
										</table>
			...
			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-117">line 117</a></p>
								</div>
							</div>
			...
			<h4 id="~event:test.my-api" class="event public"><span class="name">"test.my-api"</span></h4>
	...
	<div class="symbol-details-inner">
			...
			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-85">line 85</a></p>
								</div>
							</div>
	...
	<div class="symbol-details-inner">
			...
			<div class="callout callout-default"><h5>Details</h5>		<form class="form-horizontal details">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Source</label>
								<div class="col-sm-9">
									<p class="form-control-static"><a href="MyApi.js.html">MyApi.js</a>, <a href="MyApi.js.html#line-108">line 108</a></p>
								</div>
							</div>
