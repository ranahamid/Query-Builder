...
<body>
	...
	<!-- end:navbar.hbs -->		<div class="page-header">
			<div class="container">
				...
				<h1><span class="name">CustomError</span></h1>
				<div class="summary"><p>A global custom error.</p></div>			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-9 main-content">
						<ol class="breadcrumb">
							...
							<li class="active">CustomError</li>
						</ol>
					<section>
							<dl class="symbol primary">
								<dt class="symbol-title class collapsible-symbol expanded">
			<h2 class="class"><span class="signature-new">new&nbsp;</span><span class="name">CustomError</span><span class="signature-params">( <span class="signature-param">message</span>&nbsp;)</span><span class="signature-type"></span></h2>
...
<dd class="symbol-details class  collapsible-symbol expanded" style="max-height: 9999px;">
	<div class="symbol-details-inner">
			<div class="callout callout-primary"><h5>Description</h5>		<div class="description"><p>As this is just a test file there is no implementation of inheriting the Error.prototype or fixing of the stack trace, this is a dummy dummy object to test the documentation.</p></div>
			...
			<div class="callout callout-example"><h5>Examples</h5>		<div class="example-caption"><p>Use this class like any standard error object.</p></div>
					<div class="example-code">
						<pre class="prettyprint source language-javascript"><code class="language-javascript">throw new CustomError(&quot;Oh no! It broke :(&quot;);</code></pre>
					</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<p class="form-control-static"><a href="CustomError.js.html">CustomError.js</a>, <a href="CustomError.js.html#line-1">line 1</a></p>
								</div>
							</div>
